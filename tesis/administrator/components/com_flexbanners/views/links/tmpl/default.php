		...
		<thead>
			<tr>
				...
				<th class="title nowrap" style="text-align:left">
					<?php echo JHtml::_('grid.sort', 'ADMIN_FLEXBANNER_LINKNAME', 'a.linkname', $listDirn, $listOrder); ?>
				</th>
				<th class="title nowrap" style="text-align:left">
					<?php echo JHtml::_('grid.sort', 'ADMIN_FLEXBANNER_LINKURL', 'a.linkurl', $listDirn, $listOrder); ?>
				</th>
...
?>
						<div class="pull-left">
							<?php
								...
								JHtml::_('dropdown.edit', $item->linkid, 'link.', JRoute::_('index.php?option=com_flexbanners&task=link.edit&linkid='.(int) $item->linkid));
								...
								if ($archived) :
									JHtml::_('dropdown.unarchive', 'cb' . $i, 'links.');
								else :
									JHtml::_('dropdown.archive', 'cb' . $i, 'links.');
								endif;

								if ($item->checked_out) :
									JHtml::_('dropdown.checkin', 'cb' . $i, 'links.');
								endif;
