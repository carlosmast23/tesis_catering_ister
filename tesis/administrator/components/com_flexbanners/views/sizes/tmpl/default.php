		...
		<thead>
			<tr>
				...
				<th class="title" style="text-align:left">
					<?php echo JHtml::_('grid.sort', 'ADMIN_FLEXBANNER_SIZENAME', 'a.sizename', $listDirn, $listOrder); ?>
				</th>
				<th width="20%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'ADMIN_FLEXBANNER_SIZEWIDTH', 'a.width', $listDirn, $listOrder); ?>
				</th>
				<th width="20%">
					<?php echo JHtml::_('grid.sort', 'ADMIN_FLEXBANNER_SIZEHEIGHT', 'a.height', $listDirn, $listOrder); ?>
				</th>
				<th width="10%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'ADMIN_FLEXBANNER_MAXFILESIZE', 'a.maxfilesize', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
...
?>
						<div class="pull-left">
							<?php
								...
								JHtml::_('dropdown.edit', $item->sizeid, 'size.', JRoute::_('index.php?option=com_flexbanners&task=size.edit&sizeid='.(int) $item->sizeid));
