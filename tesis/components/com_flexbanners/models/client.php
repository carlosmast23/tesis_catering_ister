...
class FlexbannersModelClient extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->where('cl.juserid = '.(int) $clientId);
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$locationId = $this->getUserStateFromRequest($this->context.'.filter.locationid', 'filter_locationid', '');
		$this->setState('filter.locationid', $locationId);
