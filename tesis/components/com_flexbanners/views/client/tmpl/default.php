...
<form action="<?php echo JRoute::_('index.php?option=com_flexbanners&view=client'); ?>" method="post" name="adminForm" id="adminForm flexbanner">


	<table class="flexbtable">
		<thead>
			<tr>
				<th align="left">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="center">
					...
					echo number_format($this->escape($item->impmade),0).JText::_('FLEXBANNER_BANNEROF').$maximpdisplay; 
					?>
				</td>
				<td class="center">
					<?php 
					...
					echo number_format($this->escape($item->clicks,0)).JText::_('FLEXBANNER_BANNEROF').$maxclickdisplay; 
					?>
				</td>
				<td class="center">
					<?php 
